...
\begin{exmp} Sea \( x = (λv_{0}.(v_{00} (λv_{00}.v_{000}))) \), \( x \in Λ \) ya que
...
\subsection{Clasificación de términos}
...
\paragraph{Pendiente} Aqui va redactada parte del contenido de la teoría \( λKβ \)
