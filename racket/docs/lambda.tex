...
\nwenddocs{}\nwbegindocs{100}\paragraph{De expresiones a \LaTeX} Traducir expresiones a código interpretable por \LaTeX{} es relativamente fácil, esta tarea se divide en dos: la escritura de la expresión en sí y la plantilla del documento. Primero se define la plantilla del documento en donde se encuentra el preámbulo, el {\tt{}{\char92}begin{\char123}document{\char125}} y {\tt{}{\char92}end{\char123}document{\char125}}. El parámetro {\tt{}\protect\nwindexuse{plantilla-latex}{plantilla-latex}{NWlam9-A*LH-1}plantilla-latex} contiene una cadena de caracteres que es utilizada de tal manera que {\tt{}(format\ (\protect\nwindexuse{plantilla-latex}{plantilla-latex}{NWlam9-A*LH-1}plantilla-latex)\ expresión-latex)} sea una cadena de caracteres con el contenido de un documento válido de \LaTeX{}.
...
\nwidentdefs{\\{{plantilla-latex}{plantilla-latex}}}\nwalsodefined{\\{NWlam9-A*LH-2}\\{NWlam9-A*LH-3}\\{NWlam9-A*LH-4}\\{NWlam9-A*LH-5}\\{NWlam9-A*LH-6}\\{NWlam9-A*LH-7}}\nwused{\\{NWlam9-escC-1}}\nwendcode{}\nwbegindocs{102}\nwdocspar

Los escritores para \LaTeX{} tienen una estructura similar a los de texto plano, la única diferencia es que se escriben comandos del modo de matemáticas de \LaTeX{} para darle formato a las expresiones. La definición del procedimiento {\tt{}\protect\nwindexuse{expresión->latex}{expresión->latex}{NWlam9-A*LH-2}expresión->latex} es similar a {\tt{}\protect\nwindexuse{expresión->texto-plano}{expresión->texto-plano}{NWlam9-A*tN-1}expresión->texto-plano}.

\nwenddocs{}\nwbegincode{103}\sublabel{NWlam9-A*LH-2}\nwmargintag{{\nwtagstyle{}\subpageref{NWlam9-A*LH-2}}}\moddef{A LaTeX sin abuso~{\nwtagstyle{}\subpageref{NWlam9-A*LH-1}}}\plusendmoddef
...
\nwindexdefn{expresión->latex}{expresión->latex}{NWlam9-A*LH-2}\eatline
\nwidentdefs{\\{{expresión->latex}{expresión->latex}}}\nwidentuses{\\{{abstracción}{abstracción}}\\{{abstracción->latex}{abstracción->latex}}\\{{aplicación}{aplicación}}\\{{aplicación->latex}{aplicación->latex}}\\{{hueco}{hueco}}\\{{hueco->latex}{hueco->latex}}\\{{metainstrucción}{metainstrucción}}\\{{metainstrucción->latex}{metainstrucción->latex}}\\{{variable}{variable}}\\{{variable->latex}{variable->latex}}}\nwindexuse{abstracción}{abstracción}{NWlam9-A*LH-2}\nwindexuse{abstracción->latex}{abstracción->latex}{NWlam9-A*LH-2}\nwindexuse{aplicación}{aplicación}{NWlam9-A*LH-2}\nwindexuse{aplicación->latex}{aplicación->latex}{NWlam9-A*LH-2}\nwindexuse{hueco}{hueco}{NWlam9-A*LH-2}\nwindexuse{hueco->latex}{hueco->latex}{NWlam9-A*LH-2}\nwindexuse{metainstrucción}{metainstrucción}{NWlam9-A*LH-2}\nwindexuse{metainstrucción->latex}{metainstrucción->latex}{NWlam9-A*LH-2}\nwindexuse{variable}{variable}{NWlam9-A*LH-2}\nwindexuse{variable->latex}{variable->latex}{NWlam9-A*LH-2}\nwendcode{}\nwbegindocs{104}\nwdocspar

Para la traducción de una variable a \LaTeX{} sin abuso de notación simplemente se obtiene su nombre.

\nwenddocs{}\nwbegincode{105}\sublabel{NWlam9-A*LH-3}\nwmargintag{{\nwtagstyle{}\subpageref{NWlam9-A*LH-3}}}\moddef{A LaTeX sin abuso~{\nwtagstyle{}\subpageref{NWlam9-A*LH-1}}}\plusendmoddef
(define (variable->latex e)
  (variable-nombre e))

\nwindexdefn{variable->latex}{variable->latex}{NWlam9-A*LH-3}\eatline
\nwidentdefs{\\{{variable->latex}{variable->latex}}}\nwidentuses{\\{{variable}{variable}}}\nwindexuse{variable}{variable}{NWlam9-A*LH-3}\nwendcode{}\nwbegindocs{106}\nwdocspar

La traducción de una abstracción a \LaTeX{} sin abuso de notación es igual que en el caso de texto plano, solo que el símbolo \( λ \) es escrito {\tt{}{\char92}lambda}.

\nwenddocs{}\nwbegincode{107}\sublabel{NWlam9-A*LH-4}\nwmargintag{{\nwtagstyle{}\subpageref{NWlam9-A*LH-4}}}\moddef{A LaTeX sin abuso~{\nwtagstyle{}\subpageref{NWlam9-A*LH-1}}}\plusendmoddef
(define (abstracción->latex e)
  (format "(\\\\lambda ~a . ~a)"
          (variable->latex (abstracción-argumento e))
          (expresión->latex (abstracción-cuerpo e))))

\nwindexdefn{abstracción->latex}{abstracción->latex}{NWlam9-A*LH-4}\eatline
\nwidentdefs{\\{{abstracción->latex}{abstracción->latex}}}\nwidentuses{\\{{abstracción}{abstracción}}\\{{expresión->latex}{expresión->latex}}\\{{variable}{variable}}\\{{variable->latex}{variable->latex}}}\nwindexuse{abstracción}{abstracción}{NWlam9-A*LH-4}\nwindexuse{expresión->latex}{expresión->latex}{NWlam9-A*LH-4}\nwindexuse{variable}{variable}{NWlam9-A*LH-4}\nwindexuse{variable->latex}{variable->latex}{NWlam9-A*LH-4}\nwendcode{}\nwbegindocs{108}\nwdocspar

De manera similar se traduce una aplicación a \LaTeX{} sin abuso de notación, la diferencia en este caso es que el espacio entre el operador y el operando se escribe {\tt{}{\char92},\ }.

\nwenddocs{}\nwbegincode{109}\sublabel{NWlam9-A*LH-5}\nwmargintag{{\nwtagstyle{}\subpageref{NWlam9-A*LH-5}}}\moddef{A LaTeX sin abuso~{\nwtagstyle{}\subpageref{NWlam9-A*LH-1}}}\plusendmoddef
(define (aplicación->latex e)
  (format "(~a\\\\, ~a)"
          (expresión->latex (aplicación-operador e))
          (expresión->latex (aplicación-operando e))))

\nwindexdefn{aplicación->latex}{aplicación->latex}{NWlam9-A*LH-5}\eatline
\nwidentdefs{\\{{aplicación->latex}{aplicación->latex}}}\nwidentuses{\\{{aplicación}{aplicación}}\\{{expresión->latex}{expresión->latex}}}\nwindexuse{aplicación}{aplicación}{NWlam9-A*LH-5}\nwindexuse{expresión->latex}{expresión->latex}{NWlam9-A*LH-5}\nwendcode{}\nwbegindocs{110}\nwdocspar

Para traducir un hueco a \LaTeX{} sin abuso de notación se traduce el espacio como {\tt{}{\char92}quad}.

\nwenddocs{}\nwbegincode{111}\sublabel{NWlam9-A*LH-6}\nwmargintag{{\nwtagstyle{}\subpageref{NWlam9-A*LH-6}}}\moddef{A LaTeX sin abuso~{\nwtagstyle{}\subpageref{NWlam9-A*LH-1}}}\plusendmoddef
(define (hueco->latex e)
  "[\\\\quad ]")

\nwindexdefn{hueco->latex}{hueco->latex}{NWlam9-A*LH-6}\eatline
\nwidentdefs{\\{{hueco->latex}{hueco->latex}}}\nwidentuses{\\{{hueco}{hueco}}}\nwindexuse{hueco}{hueco}{NWlam9-A*LH-6}\nwendcode{}\nwbegindocs{112}\nwdocspar

Para traducir una metainstrucción a \LaTeX{} sin abuso de notación se computa la lista de cadenas de los argumentos separados por la coma y el espacio {\tt{}{\char92},\ }.

\nwenddocs{}\nwbegincode{113}\sublabel{NWlam9-A*LH-7}\nwmargintag{{\nwtagstyle{}\subpageref{NWlam9-A*LH-7}}}\moddef{A LaTeX sin abuso~{\nwtagstyle{}\subpageref{NWlam9-A*LH-1}}}\plusendmoddef
...
\nwindexdefn{metainstrucción->latex}{metainstrucción->latex}{NWlam9-A*LH-7}\eatline
\nwidentdefs{\\{{metainstrucción->latex}{metainstrucción->latex}}}\nwidentuses{\\{{expresión->latex}{expresión->latex}}\\{{metainstrucción}{metainstrucción}}}\nwindexuse{expresión->latex}{expresión->latex}{NWlam9-A*LH-7}\nwindexuse{metainstrucción}{metainstrucción}{NWlam9-A*LH-7}\nwendcode{}\nwbegindocs{114}\nwdocspar

La implementación del escritor a \LaTeX{} con abuso de notación sigue el algoritmo de escritura a texto plano con abuso.

Siguiendo las convenciones de los escritores previamente definidos, {\tt{}\protect\nwindexuse{expresión->abuso-latex}{expresión->abuso-latex}{NWlam9-A*LH.2-1}expresión->abuso-latex} implementa el despacho a escritores especializados por la clase de expresión.

\nwenddocs{}\nwbegincode{115}\sublabel{NWlam9-A*LH.2-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlam9-A*LH.2-1}}}\moddef{A LaTeX con abuso~{\nwtagstyle{}\subpageref{NWlam9-A*LH.2-1}}}\endmoddef
...
\nwindexdefn{expresión->abuso-latex}{expresión->abuso-latex}{NWlam9-A*LH.2-1}\eatline
\nwidentdefs{\\{{expresión->abuso-latex}{expresión->abuso-latex}}}\nwidentuses{\\{{abstracción}{abstracción}}\\{{abstracción->abuso-latex}{abstracción->abuso-latex}}\\{{aplicación}{aplicación}}\\{{aplicación->abuso-latex}{aplicación->abuso-latex}}\\{{hueco}{hueco}}\\{{hueco->abuso-latex}{hueco->abuso-latex}}\\{{metainstrucción}{metainstrucción}}\\{{metainstrucción->abuso-latex}{metainstrucción->abuso-latex}}\\{{variable}{variable}}\\{{variable->abuso-latex}{variable->abuso-latex}}}\nwindexuse{abstracción}{abstracción}{NWlam9-A*LH.2-1}\nwindexuse{abstracción->abuso-latex}{abstracción->abuso-latex}{NWlam9-A*LH.2-1}\nwindexuse{aplicación}{aplicación}{NWlam9-A*LH.2-1}\nwindexuse{aplicación->abuso-latex}{aplicación->abuso-latex}{NWlam9-A*LH.2-1}\nwindexuse{hueco}{hueco}{NWlam9-A*LH.2-1}\nwindexuse{hueco->abuso-latex}{hueco->abuso-latex}{NWlam9-A*LH.2-1}\nwindexuse{metainstrucción}{metainstrucción}{NWlam9-A*LH.2-1}\nwindexuse{metainstrucción->abuso-latex}{metainstrucción->abuso-latex}{NWlam9-A*LH.2-1}\nwindexuse{variable}{variable}{NWlam9-A*LH.2-1}\nwindexuse{variable->abuso-latex}{variable->abuso-latex}{NWlam9-A*LH.2-1}\nwalsodefined{\\{NWlam9-A*LH.2-2}}\nwused{\\{NWlam9-escC-1}}\nwendcode{}\nwbegindocs{116}\nwdocspar
...
\nwenddocs{}\nwbegincode{117}\sublabel{NWlam9-A*LH.2-2}\nwmargintag{{\nwtagstyle{}\subpageref{NWlam9-A*LH.2-2}}}\moddef{A LaTeX con abuso~{\nwtagstyle{}\subpageref{NWlam9-A*LH.2-1}}}\plusendmoddef
...
\nwindexdefn{variable->abuso-latex}{variable->abuso-latex}{NWlam9-A*LH.2-2}\nwindexdefn{abstracción->abuso-latex}{abstracción->abuso-latex}{NWlam9-A*LH.2-2}\nwindexdefn{aplicación->abuso-latex}{aplicación->abuso-latex}{NWlam9-A*LH.2-2}\nwindexdefn{hueco->abuso-latex}{hueco->abuso-latex}{NWlam9-A*LH.2-2}\nwindexdefn{metainstrucción->abuso-latex}{metainstrucción->abuso-latex}{NWlam9-A*LH.2-2}\eatline
\nwidentdefs{\\{{abstracción->abuso-latex}{abstracción->abuso-latex}}\\{{aplicación->abuso-latex}{aplicación->abuso-latex}}\\{{hueco->abuso-latex}{hueco->abuso-latex}}\\{{metainstrucción->abuso-latex}{metainstrucción->abuso-latex}}\\{{variable->abuso-latex}{variable->abuso-latex}}}\nwidentuses{\\{{abstracción}{abstracción}}\\{{aplicación}{aplicación}}\\{{expresión->abuso-latex}{expresión->abuso-latex}}\\{{hueco}{hueco}}\\{{metainstrucción}{metainstrucción}}\\{{variable}{variable}}\\{{variable->texto-plano}{variable->texto-plano}}}\nwindexuse{abstracción}{abstracción}{NWlam9-A*LH.2-2}\nwindexuse{aplicación}{aplicación}{NWlam9-A*LH.2-2}\nwindexuse{expresión->abuso-latex}{expresión->abuso-latex}{NWlam9-A*LH.2-2}\nwindexuse{hueco}{hueco}{NWlam9-A*LH.2-2}\nwindexuse{metainstrucción}{metainstrucción}{NWlam9-A*LH.2-2}\nwindexuse{variable}{variable}{NWlam9-A*LH.2-2}\nwindexuse{variable->texto-plano}{variable->texto-plano}{NWlam9-A*LH.2-2}\nwendcode{}\nwbegindocs{118}\nwdocspar

\nwenddocs{}\nwbegindocs{119}\paragraph{Módulo de escritor} El módulo de los escritores utiliza el módulo {\tt{}estructuras.rkt} y provee los procedimientos de escritura a texto plano, \LaTeX~ y a figuras de {\tt{}Racket} con abuso y sin abuso de notación. El archivo {\tt{}escritor.rkt} contiene este módulo y tiene la siguiente forma.

\nwenddocs{}\nwbegincode{120}\sublabel{NWlam9-escC-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlam9-escC-1}}}\moddef{escritor.rkt~{\nwtagstyle{}\subpageref{NWlam9-escC-1}}}\endmoddef
;;; -*- mode: racket; coding: utf-8 -*-
;;; Copyright (C) 2016 Eduardo Acuña Yeomans <eduardo.acye@gmail.com>
;;; Procura no editar este archivo, mejor modifica lambda.nw
...
\LA{}A LaTeX con abuso~{\nwtagstyle{}\subpageref{NWlam9-A*LH.2-1}}\RA{}
\nwidentuses{\\{{expresión->abuso-latex}{expresión->abuso-latex}}\\{{expresión->abuso-texto-plano}{expresión->abuso-texto-plano}}\\{{expresión->latex}{expresión->latex}}\\{{expresión->texto-plano}{expresión->texto-plano}}\\{{plantilla-latex}{plantilla-latex}}}\nwindexuse{expresión->abuso-latex}{expresión->abuso-latex}{NWlam9-escC-1}\nwindexuse{expresión->abuso-texto-plano}{expresión->abuso-texto-plano}{NWlam9-escC-1}\nwindexuse{expresión->latex}{expresión->latex}{NWlam9-escC-1}\nwindexuse{expresión->texto-plano}{expresión->texto-plano}{NWlam9-escC-1}\nwindexuse{plantilla-latex}{plantilla-latex}{NWlam9-escC-1}\nwnotused{escritor.rkt}\nwendcode{}\nwbegindocs{121}\nwdocspar

\nwenddocs{}\nwbegindocs{122}\paragraph{Pruebas de escritores} El archivo de pruebas {\tt{}escritor-pruebas.rkt} es utilizado para verificar si la funcionalidad de los escritores es la esperada. Se omite su definición en este documento pero es distribuído con el código del trabajo.


\nwenddocs{}\nwbegindocs{123}\section*{Evaluador de expresiones}

\nwenddocs{}\nwbegincode{124}\sublabel{NWlam9-EvaW-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlam9-EvaW-1}}}\moddef{Evaluación de metainstrucciones~{\nwtagstyle{}\subpageref{NWlam9-EvaW-1}}}\endmoddef
...
\nwindexdefn{evaluar-expresión}{evaluar-expresión}{NWlam9-EvaW-1}\eatline
\nwidentdefs{\\{{evaluar-expresión}{evaluar-expresión}}}\nwidentuses{\\{{abstracción}{abstracción}}\\{{aplicación}{aplicación}}\\{{hueco}{hueco}}\\{{metainstrucción}{metainstrucción}}\\{{metainstrucciones}{metainstrucciones}}\\{{variable}{variable}}}\nwindexuse{abstracción}{abstracción}{NWlam9-EvaW-1}\nwindexuse{aplicación}{aplicación}{NWlam9-EvaW-1}\nwindexuse{hueco}{hueco}{NWlam9-EvaW-1}\nwindexuse{metainstrucción}{metainstrucción}{NWlam9-EvaW-1}\nwindexuse{metainstrucciones}{metainstrucciones}{NWlam9-EvaW-1}\nwindexuse{variable}{variable}{NWlam9-EvaW-1}\nwnotused{Evaluación\ de\ metainstrucciones}\nwendcode{}\nwbegindocs{125}\nwdocspar

\nwenddocs{}\nwbegincode{126}\sublabel{NWlam9-RegT-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlam9-RegT-1}}}\moddef{Registro de metainstrucciones~{\nwtagstyle{}\subpageref{NWlam9-RegT-1}}}\endmoddef
(define metainstrucciones (make-hash))

\nwindexdefn{metainstrucciones}{metainstrucciones}{NWlam9-RegT-1}\eatline
\nwidentdefs{\\{{metainstrucciones}{metainstrucciones}}}\nwnotused{Registro\ de\ metainstrucciones}\nwendcode{}\nwbegindocs{127}\nwdocspar


\nwenddocs{}\nwbegincode{128}\sublabel{NWlam9-Macb-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlam9-Macb-1}}}\moddef{Macros para definir metainstrucciones~{\nwtagstyle{}\subpageref{NWlam9-Macb-1}}}\endmoddef
...
\nwindexdefn{define-metainstrucción}{define-metainstrucción}{NWlam9-Macb-1}\nwindexdefn{define-instrucción}{define-instrucción}{NWlam9-Macb-1}\eatline
\nwidentdefs{\\{{define-instrucción}{define-instrucción}}\\{{define-metainstrucción}{define-metainstrucción}}}\nwidentuses{\\{{evaluar-expresión}{evaluar-expresión}}\\{{metainstrucción}{metainstrucción}}\\{{metainstrucciones}{metainstrucciones}}}\nwindexuse{evaluar-expresión}{evaluar-expresión}{NWlam9-Macb-1}\nwindexuse{metainstrucción}{metainstrucción}{NWlam9-Macb-1}\nwindexuse{metainstrucciones}{metainstrucciones}{NWlam9-Macb-1}\nwnotused{Macros\ para\ definir\ metainstrucciones}\nwendcode{}\nwbegindocs{129}\nwdocspar


\nwenddocs{}\nwbegincode{130}\sublabel{NWlam9-InsD-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlam9-InsD-1}}}\moddef{Instrucciones~{\nwtagstyle{}\subpageref{NWlam9-InsD-1}}}\endmoddef
...
\nwindexdefn{decodifica-numeral}{decodifica-numeral}{NWlam9-InsD-1}\eatline
\nwidentdefs{\\{{decodifica-numeral}{decodifica-numeral}}}\nwidentuses{\\{{abstracción}{abstracción}}\\{{aplicación}{aplicación}}\\{{define-instrucción}{define-instrucción}}\\{{variable}{variable}}}\nwindexuse{abstracción}{abstracción}{NWlam9-InsD-1}\nwindexuse{aplicación}{aplicación}{NWlam9-InsD-1}\nwindexuse{define-instrucción}{define-instrucción}{NWlam9-InsD-1}\nwindexuse{variable}{variable}{NWlam9-InsD-1}\nwalsodefined{\\{NWlam9-InsD-2}}\nwnotused{Instrucciones}\nwendcode{}\nwbegindocs{131}\nwdocspar


\nwenddocs{}\nwbegincode{132}\sublabel{NWlam9-InsD-2}\nwmargintag{{\nwtagstyle{}\subpageref{NWlam9-InsD-2}}}\moddef{Instrucciones~{\nwtagstyle{}\subpageref{NWlam9-InsD-1}}}\plusendmoddef
...
\nwindexdefn{codifica-número}{codifica-número}{NWlam9-InsD-2}\eatline
\nwidentdefs{\\{{codifica-número}{codifica-número}}}\nwidentuses{\\{{abstracción}{abstracción}}\\{{aplicación}{aplicación}}\\{{define-instrucción}{define-instrucción}}\\{{variable}{variable}}}\nwindexuse{abstracción}{abstracción}{NWlam9-InsD-2}\nwindexuse{aplicación}{aplicación}{NWlam9-InsD-2}\nwindexuse{define-instrucción}{define-instrucción}{NWlam9-InsD-2}\nwindexuse{variable}{variable}{NWlam9-InsD-2}\nwendcode{}\nwbegindocs{133}\nwdocspar


\nwenddocs{}\nwbegindocs{134}\section*{Ciclo de Lectura Evaluación y Escritura}

\paragraph{Pendiente}

\nwenddocs{}\nwbegindocs{135}\section*{Editor estructural}

\paragraph{Pendiente}

\nwenddocs{}

\nwixlogsorted{c}{{A LaTeX con abuso}{NWlam9-A*LH.2-1}{\nwixd{NWlam9-A*LH.2-1}\nwixd{NWlam9-A*LH.2-2}\nwixu{NWlam9-escC-1}}}%
...
\nwixlogsorted{c}{{Evaluación de metainstrucciones}{NWlam9-EvaW-1}{\nwixd{NWlam9-EvaW-1}}}%
\nwixlogsorted{c}{{Instrucciones}{NWlam9-InsD-1}{\nwixd{NWlam9-InsD-1}\nwixd{NWlam9-InsD-2}}}%
\nwixlogsorted{c}{{Macros para definir metainstrucciones}{NWlam9-Macb-1}{\nwixd{NWlam9-Macb-1}}}%
...
\nwixlogsorted{i}{{abstracción->abuso-latex}{abstracción->abuso-latex}}%
\nwixlogsorted{i}{{abstracción->abuso-texto-plano}{abstracción->abuso-texto-plano}}%
\nwixlogsorted{i}{{abstracción->latex}{abstracción->latex}}%
\nwixlogsorted{i}{{aplicación}{aplicación}}%
\nwixlogsorted{i}{{aplicación->abuso-latex}{aplicación->abuso-latex}}%
...
\nwixlogsorted{i}{{aplicación->latex}{aplicación->latex}}%
\nwixlogsorted{i}{{codifica-número}{codifica-número}}%
\nwixlogsorted{i}{{decodifica-numeral}{decodifica-numeral}}%
\nwixlogsorted{i}{{define-instrucción}{define-instrucción}}%
...
\nwixlogsorted{i}{{variable->abuso-latex}{variable->abuso-latex}}%
\nwixlogsorted{i}{{variable->abuso-texto-plano}{variable->abuso-texto-plano}}%
\nwixlogsorted{i}{{variable->latex}{variable->latex}}%
\nwixlogsorted{i}{{variable->texto-plano}{variable->texto-plano}}%
\nwbegindocs{136}\section*{¿Cómo hackear la \( \bs{λ} \)?}
